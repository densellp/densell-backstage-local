...
export const ExampleFetchComponent = () => {
  ...
  //     const result = await get('http://localhost:3001/health'); // Replace with your endpoint
  //     setData(result);
  //   };
  ...
  //   const result = await post('http://localhost:3001/post', { key: 'info' }); // Replace with your endpoint and data
  //   console.log(result);
  // };
  ...
  // useEffect(() => {
  //   fetch('http://localhost:3001/testGet')
  ...
  // return (
  //   <div>
  //     {/* <Typography variant="body1">{data ? JSON.stringify(data) : 'Loading...'}</Typography> */}
  //     <Button onClick={() => {
  //       fetch('http://localhost:3001/testGet')
  //         .then(response => response.json())
  //         .then(data => setHealth(data))
